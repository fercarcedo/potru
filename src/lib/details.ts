...
export const DETAILS: Record<string, string> = {
  ...
  'autovia-minera': mkSection('Troncal propia · Autovía AS-I Mieres–Gijón (corte esquemático)', 8,
    {
      access: [6, 7, 8], labels: [
  ...
  /* the mining valleys */
  'cuencas': mkSection('Cable propio TRONSCPLEFO32 · 32 ff.oo. · Mieres–Pola de Lena', 4,
  ...
  'troncal-occidental': mkSection('Cable CUDILLERO–CASTROPOL · 64 ff.oo. · 8 tubos × 8 fibras (vía ADIF)', 8,
    {
  ...
  /* Muros CWDM */
  'muros': mkCWDM('Desglose CWDM 8133 de Muros de Nalón → Gijón (colores normalizados por λ)', [
